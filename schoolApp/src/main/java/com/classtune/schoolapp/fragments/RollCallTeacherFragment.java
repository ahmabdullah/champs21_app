...
import com.classtune.schoolapp.fragments.LeaveApplicationDialogFragment.LeaveApplicationStatusListener;
	...
	PickerItemSelectedListener PickerCallback = new PickerItemSelectedListener() {
		...
		public void onPickerItemSelected(BaseType item) {
			...
			case TEACHER_BATCH:
				...
				Intent i = new Intent("com.classtune.schoolapp.batch");
