...
import com.classtune.freeversion.AssesmentActivity;
import com.classtune.freeversion.CandleActivity;
import com.classtune.freeversion.CompleteProfileActivityContainer;
import com.classtune.freeversion.GoodReadActivity;
import com.classtune.freeversion.HomeContainerActivity;
import com.classtune.freeversion.HomePageFreeVersion;
import com.classtune.freeversion.PaidVersionHomeFragment;
import com.classtune.freeversion.SchoolFreeVersionActivity;
import com.classtune.freeversion.SingleItemShowActivity;
import com.classtune.freeversion.SingleSchoolFreeVersionActivity;
import com.classtune.schoolapp.ChildSelectionActivity;
import com.classtune.schoolapp.LoginActivity;
import com.classtune.schoolapp.R;
import com.classtune.schoolapp.model.AddData;
import com.classtune.schoolapp.model.FreeVersionPost;
import com.classtune.schoolapp.model.SubCategory;
...
import com.classtune.schoolapp.networking.SchoolAppPostRequest;
...
import com.classtune.schoolapp.viewhelpers.CustomRhombusIcon;
import com.classtune.schoolapp.viewhelpers.CustomTabButton;
import com.classtune.schoolapp.viewhelpers.PagerContainer;
import com.classtune.schoolapp.viewhelpers.PopupDialog;
import com.classtune.schoolapp.viewhelpers.ResizableImageView;
import com.classtune.schoolapp.viewhelpers.UIHelper;
import com.classtune.schoolapp.viewhelpers.UninterceptableViewPager;
import com.classtune.spellingbee.LeaderBoardActivity;
import com.classtune.spellingbee.SpellingbeeRulesActivity;
import com.classtune.spellingbee.SpellingbeeTestActivity;
...
public class CommonChildFragment extends Fragment implements UserAuthListener,
    ...
    private void loadDataInToList() {
        ...
        if (!currentCategoryId.equals("-1")) {
            ...
            if (currentCategoryId.equals("7")) headerBlock.setVisibility(View.GONE);
            else headerBlock.setVisibility(View.VISIBLE);
        } else headerBlock.setVisibility(View.VISIBLE);
        /*
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        headerBlock = (LinearLayout) view.findViewById(R.id.header_block);
            ...
            for (int i = 0; i < allpost.size(); i++) {
                ...
                if (allpost.get(i).getPostType().equals("2")) {
                    ...
                    switch (allpost.get(i).getNormal_post_type()) {
                        case 0:
						/*if(allpost.get(i).getIsSpellingbee().equals("1")){
    ...
    private class EfficientAdapter extends BaseAdapter {
        ...
        private static final int TYPE_SB_STATIC = 15;
        private static final int TYPE_MAX_COUNT = 16;
        ...
        private TreeSet<Integer> mSbStatic = new TreeSet<Integer>();
        ...
        public void addSbStaticItem(final FreeVersionPost item) {
            list.add(item);
            mSbStatic.add(list.size() - 1);
        }
        ...
        public int getItemViewType(int position) {
            ...
            if (mSbStatic.contains(position))
                return TYPE_SB_STATIC;
            return TYPE_ITEM;
