...
import com.classtune.schoolapp.BatchSelectionChangedBroadcastReceiver;
import com.classtune.schoolapp.BatchSelectionChangedBroadcastReceiver.onBatchIdChangeListener;
import com.classtune.schoolapp.R;
import com.classtune.schoolapp.StudentListActivity;
...
import com.classtune.schoolapp.utils.ClickSpan;
...
public class ClassReportTeacherFragment extends Fragment implements
	...
	public void onResume() {
		...
		super.onResume();
		getActivity().registerReceiver(reciever, new IntentFilter("com.classtune.schoolapp.batch"));
	}
	...
	public static void clickify(
			...
			final com.classtune.schoolapp.utils.ClickSpan.OnClickListener listener) {
